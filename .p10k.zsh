# Generated by Powerlevel10k configuration wizard on 2024-03-18 at 19:51 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=133
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=145
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%80F'   # green foreground
      local   modified='%179F'  # yellow foreground
      local  untracked='%129F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=74
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=97
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=97
